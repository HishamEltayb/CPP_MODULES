...
/*   Updated: 2024/09/11 21:13:09 by heltayb          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
Fixed::Fixed(const Fixed &existObject)
{
	...
	// this->setRawBits(existObject.getRawBits());
	this->fixedPointNumber = existObject.fixedPointNumber;
	// this->fixedPointNumber = 12;
	// this->fixedPointNumber = existObject.toInt();
	// *this = existObject;
...
{
	// Fixed temp;
	// temp.fixedPointNumber = existObject.fixedPointNumber;
	// return (temp);
